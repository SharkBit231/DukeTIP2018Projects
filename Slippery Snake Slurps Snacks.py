...
def showStartScreen():
    ...
    titleSurf1 = titleFont.render('Snaek!', True, WHITE, DARKPURPLE)
    titleSurf2 = titleFont.render('Snaek!', True, PURPLE)
...
def showGameOverScreen():
    gameOverFont = pygame.font.Font('freesansbold.ttf', 140)
    gameSurf = gameOverFont.render('Get', True, GREEN)
    overSurf = gameOverFont.render('Rekt', True, DARKGREEN)
